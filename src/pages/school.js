...
const plotHome = () => (
  <Layout>
    <SEO title="plöt school" keywords={[`plot`, `school`, `education`, `new system`]}/>
    <DesktopHome>
    <Link to="/">
    <BackButton src="/leftarrow.svg" /></Link>
    <Logo src="/plotschoolcap.png"/>
      <br/><br/><br/>
    <Row>
      <Col sm={1.5}/>
      <Col sm={4}>
      <Title>
      achieve<br/>mastery. <br/><font color="green"> not grades.</font>
      </Title>
      </Col>
      <Col sm={1}/>
      <Col sm={4}>
      ...
      <Col sm={1.5}/>
              ...
              <Card bg="#F9BEBE;">
                ...
                <Col sm={2.25}/>
                <Col sm={3}>
                <Icon src="/education.svg"/>
                </Col>
                <Col sm={0.5}/>
                <Col sm={4}>
                <CardText>
                <b>we're reimagining education</b>
                </CardText>
                <CardText>
                the world is becoming more <b>digital</b> and <b>sustainable</b>. our educational systems are still stuck in the industrial-era.<br/><br/>let's change that.
                </CardText>
                </Col>
                <Col sm={2.25}/>
                </Row>
...
{/*}<CardShrink>
    ...
    <MobileLogo src="/plotschoolcap.png"/>
    <MobileArt src="/school.svg"/>
    <MobileTitle>
    achieve mastery. <br/><font color="green"> not grades.</font>
    </MobileTitle>
